...
class TestItemProgression(CupheadTestBase):
    def test_boss_phase_checks_make_plane_shrink_progression(self) -> None:
...
class TestOptionSanitizer(CupheadTestBase):
    ...
    def test_level_placements_duplicate_targets_are_sanitized(self) -> None:
        test_world = TestOptionSanitizer()
        test_world.options = {
            "level_shuffle": "enabled",
            "level_placements": {
    ...
    def test_level_placements_crossing_plane_groups_disable_plane_separate(self) -> None:
        test_world = TestOptionSanitizer()
        test_world.options = {
            "level_shuffle": "plane_separate",
            "level_placements": {
