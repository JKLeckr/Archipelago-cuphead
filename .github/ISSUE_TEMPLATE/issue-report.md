...
## What's happening?
*Tell me what is the bug. Make sure to describe where and when using the APWorld and what you are doing. Keep it clear and concise*

## Steps to reproduce
*Provide the steps for me to replicate the problem.*
1. Go to '...'
2. Click on '....'
3. Scroll down to '....'
4. See error
...
## What did you expect?
*Tell me what you expected to happen instead.*

## Logs
If applicable, add logs to aid in the explanation.

## Info:
 - OS: [e.g. Windows, Linux]
 - Version [e.g. alpha03a]

## Comments
*Say your remarks if you want. Keep it nice.*
